...
_DEPS=timer.h player.h entity.h physics.h spritesheet.h text.h tile.h camera.h
DEPS=$(patsubst %,$(IDIR)/%,$(_DEPS))

# All object files (which correspond to compiled .c files, duh) go here
_OBJ=tds.o player.o timer.o physics.o spritesheet.o text.o tile.o camera.o
